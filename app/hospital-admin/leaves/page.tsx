    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white dark:bg-gray-800 p-5 rounded-4xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row items-center gap-4">
          <div className="relative flex-1 w-full lg:w-auto">
             ...
             <input type="text" placeholder="Search applicant nomenclature..." className="w-full pl-11 pr-4 py-3 bg-gray-50 dark:bg-gray-700/50 border-none rounded-2xl text-xs font-bold focus:ring-2 focus:ring-blue-500 outline-none" />
          </div>
            ...
            <div key={leave._id} className="bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col group hover:border-blue-500 transition-all relative overflow-hidden">
              ...
              <div className="flex items-start justify-between mb-8">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       <h3 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter">{leave.applicant?.name || "Anonymous User"}</h3>
                       <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{leave.applicant?.type === 'doctor' ? 'Clinical Faculty' : 'Nursing Unit'}</p>
                    </div>
                 </div>
              ...
              <div className="flex-1 space-y-6">
                 ...
                 <div className="grid grid-cols-2 gap-4 h-[100px] items-center">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-2xl flex flex-col items-center justify-center">
                       ...
                       <p className="text-xl font-black text-blue-600 leading-none">{leave.numberOfDays || leave.duration}D</p>
                    </div>
                 </div>
