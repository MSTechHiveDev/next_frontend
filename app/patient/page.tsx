...
import { getPatientProfileAction, getPatientAppointmentsAction } from '@/lib/integrations';
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center animate-in fade-in duration-500">
                ...
                <p className="text-sm font-bold text-gray-400 uppercase tracking-widest max-w-md">
                    {profileRes.error || 'The medical data retrieval was unsuccessful. Please verify your credentials or network status.'}
                </p>
            </div>
        );
    }
