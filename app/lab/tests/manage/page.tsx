...
export default function ManageTestPage() {
    ...
    if (initialLoading) return (
        <div className="flex flex-col items-center justify-center p-20 gap-4">
            ...
            <p className="text-xs font-black text-gray-400 uppercase tracking-widest animate-pulse">Loading Test Data...</p>
        </div>
    );
    ...
    return (
        <div className="space-y-10 animate-in fade-in duration-700">
            ...
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tighter italic uppercase">{isEditMode ? 'Edit Lab Test' : 'Add Lab Test'}</h1>
                ...
                <form onSubmit={handleSubmit} className="p-10 lg:p-16 space-y-16">
                    ...
                    <div className="space-y-10">
                        <div className="flex items-center gap-4">
                            ...
                            <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter italic underline decoration-blue-500/30 decoration-4 underline-offset-8">Test Identification</h3>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="space-y-6 md:col-span-2">
                                <div className="flex items-center justify-between">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Departments *</label>
                                    <button type="button" onClick={() => setShowDeptModal(true)} className="px-5 py-2 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-xl text-[9px] font-black uppercase tracking-widest border border-indigo-100 hover:bg-indigo-600 hover:text-white transition-all">Add Department</button>
                                </div>
                    ...
                    <div className="space-y-10">
                        <div className="flex items-center gap-4">
                            ...
                            <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter italic underline decoration-purple-500/30 decoration-4 underline-offset-8">Test Specifications</h3>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                             <div className="space-y-3">
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Sample Type *</label>
                            ...
                            <div className="space-y-3">
                             ...
                             <div className="space-y-3">
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Turnaround Time (TAT)</label>
                                <div className="flex gap-2">
                                    <select
                                        className="w-full p-4 bg-gray-50 dark:bg-gray-900 border-none rounded-2xl outline-none focus:ring-2 focus:ring-purple-500 text-xs font-black dark:text-white"
                    ...
                    <div className="space-y-10">
                        <div className="flex items-center gap-4">
                            ...
                            <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter italic underline decoration-rose-500/30 decoration-4 underline-offset-8">Normal Ranges (Reference)</h3>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="p-6 bg-blue-50/50 dark:bg-blue-900/10 rounded-3xl border border-blue-100 dark:border-blue-900/30 hover:border-blue-300 transition-colors">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-800 dark:text-blue-300">Male Range</span>
                                </div>
                            ...
                            <div className="p-6 bg-pink-50/50 dark:bg-pink-900/10 rounded-3xl border border-pink-100 dark:border-pink-900/30 hover:border-pink-300 transition-colors">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-pink-800 dark:text-pink-300">Female Range</span>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <input
                                        type="number"
                            ...
                            <div className="p-6 bg-green-50/50 dark:bg-green-900/10 rounded-3xl border border-green-100 dark:border-green-900/30 hover:border-green-300 transition-colors">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-green-800 dark:text-green-300">Child Range</span>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <input
                                        type="number"
                            ...
                            <div className="p-6 bg-yellow-50/50 dark:bg-yellow-900/10 rounded-3xl border border-yellow-100 dark:border-yellow-900/30 hover:border-yellow-300 transition-colors">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-yellow-800 dark:text-yellow-300">Newborn Range</span>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <input
                                        type="number"
                            ...
                            <div className="p-6 bg-cyan-50/50 dark:bg-cyan-900/10 rounded-3xl border border-cyan-100 dark:border-cyan-900/30 hover:border-cyan-300 transition-colors">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-cyan-800 dark:text-cyan-300">Infant Range</span>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <input
                                        type="number"
                            ...
                            <div className="p-6 bg-indigo-50/50 dark:bg-indigo-900/10 rounded-3xl border border-indigo-100 dark:border-indigo-900/30 hover:border-indigo-300 transition-colors">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-800 dark:text-indigo-300">Geriatric Range</span>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <input
                                        type="number"
                    ...
                    {/* Submit Terminal */}
                     <div className="flex justify-end items-center gap-6 pt-10 border-t border-gray-100 dark:border-gray-700">
                        <button type="button" onClick={() => router.back()} className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] hover:text-rose-500 transition-colors">Cancel</button>
                        <button
                            type="submit"
                            disabled={loading}
                        ...
                        >
                            {loading ? <Activity className="w-5 h-5 animate-spin" /> : <><Save size={18} /> Save Test</>}
                        </button>
                    </div>
                </form>
            </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-[3rem] shadow-2xl w-full max-w-lg overflow-hidden border border-gray-100 dark:border-gray-700">
                         <div className="p-8 border-b border-gray-50 dark:border-gray-700 flex justify-between items-center bg-gray-50/50 dark:bg-gray-900/50">
                            <h3 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-[0.2em] italic">
                                Add {showTestModal ? 'Test' : showDeptModal ? 'Department' : showSampleModal ? 'Sample Type' : showTatModal ? 'TAT' : 'Method'}
                            </h3>
                         ...
                         <div className="p-10 space-y-8">
                            <div className="space-y-4">
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 italic">Name / Type</label>
