...
export default function DischargeLogin() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await dischargeService.login({
                logid: logid,
                password: password
            });
            ...
            sessionStorage.setItem("userRole", "DISCHARGE");
                ...
                <div className="hidden lg:flex flex-col w-1/2 items-start justify-center px-16 relative overflow-hidden bg-gray-50 dark:bg-black text-gray-900 dark:text-white">
                    ...
                    <div className="relative z-10 w-full max-w-[520px]">
                        ...
                        <h2 className="text-2xl font-semibold leading-tight mb-4">
                            Your Health Data,<br />
                            Secured & In Your Control.
                        </h2>
                        <p className="text-lg max-w-[480px] leading-relaxed opacity-70">
                            MSCureChain is a smart healthcare platform that helps hospitals manage discharge processes efficiently and securely.
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex justify-center items-center p-2 lg:p-12 bg-white dark:bg-gray-900">
                    <div className="w-full max-w-[420px]">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-sm opacity-60">Sign in to your discharge portal</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 shadow-sm border rounded-xl p-6 border-gray-100 dark:border-gray-800">
                            ...
                            <div>
                                ...
                                <div className="flex items-center border rounded-xl px-4 py-3 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 transition-all bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                                ...
                                <p className="text-xs text-right mt-1 opacity-50">{logid.length}/10</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex items-center border rounded-xl px-4 py-3 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 transition-all bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 relative">
                        ...
                        <div className="pt-6 flex justify-center">
                            <button
                                onClick={() => router.push('/')}
                                className="text-xs font-bold text-gray-400 hover:text-blue-600 transition-colors flex items-center gap-2 group uppercase tracking-widest"
                            >
