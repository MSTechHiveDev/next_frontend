    ...
    <div className="relative font-sans print-token-document" 
        ...
        <div className="grid grid-cols-3 gap-6 mb-8 p-6 rounded-2xl" 
            ...
            <div className="space-y-1 px-4" style={{ borderRight: `1px solid ${colors.gray200}` }}>
                ...
                <p className="text-base font-black leading-tight" style={{ color: colors.gray900 }}>{patient.mrn || 'N/A'}</p>
            ...
            <div className="space-y-1 pl-4">
                ...
                <p className="text-base font-black leading-tight" style={{ color: colors.gray900 }}>Dr. {doctor.name || 'Medical Officer'}</p>
